    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="tagno" class="col-sm-3 control-label">Tag Number</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="tagno" name="tagno" required>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="attendance_edit.php">
                 ...
                 <div class="form-group">
                    <label for="edit_temperature" class="col-sm-3 control-label">Temperature</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_temperature" name="temperature" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="edit_tagno" class="col-sm-3 control-label">Tag Number</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_tagno" name="tagno" required>
                    </div>
                </div>
                <div class="form-group">
